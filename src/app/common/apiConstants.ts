...
export const API_PENDING_ORDERS_LIST = SERVER_BASE_URL + "api/order/list/pending";
export const API_UPDATE_ORDER_STATUS = SERVER_BASE_URL + "api/order/updatestatus";